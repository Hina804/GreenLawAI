...
class KPKNodeSchema:
        ...
        schemas = {
            NodeLabel.LAW: {
                ...
                "optional": [
                    ...
                    "name", "content", "full_text" # NEW: Common pipeline fields
                ],
            ...
            NodeLabel.SECTION: {
                ...
                "optional": [
                    ...
                    "text"   # NEW: Alias for content often produced by pipeline
                ],
            ...
            NodeLabel.PENALTY: {
                ...
                "optional": [
                    ...
                    "calculated_by",  # NEW: From penalty_logic_engine.py
                    "temporal_validity",  # NEW: From temporal_validator.py
                    "authority_level"  # NEW: Which officer can impose
                ],
            ...
            NodeLabel.SPECIES: {
                ...
                "optional": [
                    ...
                    "working_plan_references"  # NEW: From working_plan_parser.py
                ],
            ...
            NodeLabel.AUTHORITY: {
                ...
                "optional": [
                    ...
                    "responsibilities", "contact_info", "address", "website"
                ],
                "constraints": ["UNIQUE(node_id)", "INDEX(name)"],
                "example": {
            ...
            NodeLabel.OFFICER: {
                ...
                "optional": [
                    ...
                    "location_id", "authority_id", "tenure"
                ],
    ...
    def validate_node_against_schema(node_data: Dict, node_type: NodeLabel) -> Tuple[bool, List[str]]:
        ...
        internal_metadata = {
            ...
            "section_number", "content", "name" # Whitelist common ones just in case
        }
